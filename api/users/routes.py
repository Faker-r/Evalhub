...
async def add_api_key(
    ...
    UserService().create_api_key(current_user.id, api_key_data)
...
async def list_api_keys(
    ...
    providers = UserService().list_api_keys(current_user.id)
...
async def delete_api_key(
    ...
    UserService().delete_api_key(current_user.id, provider)
