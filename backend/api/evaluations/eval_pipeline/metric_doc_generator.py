...
class MetricDescription:
    "A description of a metric, including the measure, sample level, and corpus level descriptions."
...
def get_metric_names(metric: Any) -> list[str]:
...
class MetricDocGenerator:
    @staticmethod
    def generate_metric_docs(metrics_list: list) -> dict[str, Any]:
        metrics_by_name: dict[str, list[MetricDescription]] = {}
        for metric in metrics_list:
            for name in get_metric_names(metric):
