...
from backend.evaluations.models import Trace
from backend.evaluations.repository import EvaluationRepository
from backend.evaluations.schemas import EvaluationRequest, EvaluationResponse, ScoreDistribution
from backend.guidelines.models import Guideline
from backend.guidelines.service import GuidelineService
...
class EvaluationContext:
    ...
    scores_per_guideline: dict[str, list[Optional[int]]] = field(default_factory=dict)
...
Reasoning:"""
    ...
    def _parse_score(self, response: str, max_score: int) -> tuple[Optional[int], Optional[str]]:
    ...
    def _calculate_summary(
        self,
        scores_per_guideline: dict[str, list[Optional[int]]],
