...
from backend.guidelines.schemas import GuidelineCreate
...
class GuidelineRepository:
    ...
    async def get_by_name(self, name: str) -> Optional[Guideline]:
        ...
        Returns:
            Optional[Guideline]: Found guideline or None
        """
